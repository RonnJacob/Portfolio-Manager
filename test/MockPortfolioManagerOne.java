 ...
 */
public class MockPortfolioManagerOne implements IManager<StockPortfolio> {
  ...
  @Override
  public void retrieve(String name) throws IllegalStateException, IllegalArgumentException {
    this.log.append("Retrieve portfolio " + name + "\n");
  }
}
