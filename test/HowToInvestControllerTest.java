...
public class HowToInvestControllerTest {
  ...
  public void TestPortfolioManagerEmptyInput() {
    ...
    IManager strategyModel = new MockStrategyManagerOne(logStrategyManager);
  ...
  public void TestPortfolioManagerSelectingOptionToCreateMultiple() {
    ...
    IManager strategyModel = new MockStrategyManagerOne(logStrategyModel);
    IHowToInvestView view = new MockViewOne(logView, in, out);
    IHowToInvestController controller = new HowToInvestController(view, model, strategyModel);
    controller.openPortfolioManager();
  ...
  public void TestPortfolioManagerCreatingMoreThanOneShare() {
    Reader in = new StringReader("3 1 2 FB 100 2018-10-10 l y GOOGL 20 2018-10-10 m n "
            + "q \n");
    String expected = "";
    StringWriter out = new StringWriter();
    StringBuilder logPortfolioModel = new StringBuilder();
    ...
    expected = "Home Screen Opened.\n"
            ...
            + "Portfolio Screen Opened.\n"
            + "Input received : 2\n"
            + "Buy details queried. FB 100 2018-10-10 l\n"
            + "Prompt: 100.0 share(s) of FB bought on 2018-10-10\n"
            + "Prompt: Buy more shares? (Y/N)\n"
            + "Input received : y\n"
            + "Buy details queried. GOOGL 20 2018-10-10 m\n"
            + "Prompt: 100.0 share(s) of GOOGL bought on 2018-10-10\n"
            + "Prompt: Buy more shares? (Y/N)\n"
            + "Input received : n\n"
            + "Portfolio Screen Opened.\n"
            + "Input received : q\n"
    ...
    assertEquals(expected, logView.toString());
    assertEquals("Get All Portfolios\nGet Portfolio 1\nGet Portfolio 1\nAdd stock FB for"
                    + " 100.0 on 2018-10-10 with 100.0\nAdd stock GOOGL for 20.0 on 2018-10-10 with"
                    + " 100.0\n",
            logPortfolioModel.toString());
  }
  ...
  public void TestControllerApplyStrategy() {
    ...
    assertEquals("All Portfolios\nAll Portfolios\nAll Portfolios\nAll Portfolios\n"
            + "Get Portfolio 1\nApply strategy with commision 100.0", logStrategyModel.toString());
  }
  ...
  @Test
  public void TestControllerLoadPortfolio() {
    Reader in = new StringReader("4 p2 q");
    String expected = "";
    StringWriter out = new StringWriter();
    StringBuilder logPortfolioModel = new StringBuilder();
    StringBuilder logStrategyModel = new StringBuilder();
  ...
  @Test
  public void TestControllerSavePortfolio() {
    Reader in = new StringReader("3 1 2 FB 100 2018-10-10 l n 7 savedportfolio q");
    String expected = "";
    StringWriter out = new StringWriter();
    StringBuilder logPortfolioModel = new StringBuilder();
    StringBuilder logStrategyModel = new StringBuilder();
    ...
    expected = "Home Screen Opened.\nInput received : 3\nInput received for: \n"
            ...
            + "Prompt: 100.0 share(s) of FB bought on 2018-10-10\nPrompt: Buy more shares? (Y/N)\n"
            + "Input received : n\nPortfolio Screen Opened.\nInput received : 7\n"
            + "Input received for: \nSave portfolio as: \nInput received : savedportfolio\n"
            + "Prompt: Portfolio was successfully saved.\nPortfolio Screen Opened.\nInput received"
            + " : q\n\nQuitting Manager.\n";
    assertEquals(expected, logView.toString());
    assertEquals("Get All Portfolios\nGet Portfolio 1\nGet Portfolio 1\n"
  ...
  @Test
  public void TestControllerLoadStrategy() {
    Reader in = new StringReader("3 1 6 4 s1 r q");
    String expected = "";
    StringWriter out = new StringWriter();
    StringBuilder logPortfolioModel = new StringBuilder();
    StringBuilder logStrategyModel = new StringBuilder();
    ...
    expected = "Home Screen Opened.\nInput received : 3\nInput received for: \n"
            + "Enter index of Portfolio to open.\nInput received : 1\nPortfolio Screen Opened.\n"
            + "Input received : 6\nStrategy Manager Menu Opened\nInput received : 4\n"
            + "Input received for: Enter the name of file to be loaded.\n\nInput received : s1\n"
            + "Prompt: Strategy s1 has been added.Strategy Manager Menu Opened\nInput received : "
            + "r\nPortfolio Screen Opened.\nInput received : q\n\nQuitting Manager.\n";
    assertEquals(expected, logView.toString());
    assertEquals("Get All Portfolios\nGet Portfolio 1\nGet Portfolio 1\n",
            logPortfolioModel.toString());
    assertEquals("All Portfolios\nAll Portfolios\nRetrieve Strategy s1\n",
            logStrategyModel.toString());
  }

  @Test
  public void TestControllerSaveStrategy() {
    Reader in = new StringReader("3 1 6 2 1 2 4 20 r 4 savedstrategy r r q");
    String expected = "";
    StringWriter out = new StringWriter();
    StringBuilder logPortfolioModel = new StringBuilder();
    StringBuilder logStrategyModel = new StringBuilder();
    ...
    expected = "Home Screen Opened.\nInput received : 3\nInput received for: \n"
            ...
            + "Input received : 6\nStrategy Manager Menu Opened\nInput received : 2\n"
            + "Input received for: \nEnter index of strategy to apply.\n\nInput received : 1\n"
            + "Strategy Menu Screen opened. \nInput received : 2\nStrategy modification screen "
            + "Opened.\nInput received : 4\nInput received for: Enter frequency in number of days"
            + ".\n\nInput received : 20\nStrategy modification screen Opened.\nInput received "
            + ": r\nStrategy Menu Screen opened. \nInput received : 4\nInput received for: \n"
            + "Save strategy as: \nInput received : savedstrategy\nPrompt: Strategy was "
            + "successfully saved.\nStrategy Menu Screen opened. \nInput received : r\n"
            + "Strategy Manager Menu Opened\nInput received : r\nPortfolio Screen Opened.\nInput"
            + " received : q\n\nQuitting Manager.\n";
    assertEquals(expected, logView.toString());
    assertEquals("Get All Portfolios\nGet Portfolio 1\nGet Portfolio 1\n",
            logPortfolioModel.toString());
    assertEquals("All Portfolios\nAll Portfolios\nAll Portfolios\nAll Portfolios\nGet "
                    + "Portfolio 1\nChange frequency to 20 days.\nSave strategy savedstrategy\n",
            logStrategyModel.toString());
  }
